...
const JsonEmpty = $.makeType(_.spec, "16f8c330-1509-11ed-9b7d-ad16e3379379", _.syntax.literal);
...
const $sequence = $.makeType(_.spec, "11638bc2-1509-11ed-a034-95f884e6589a", _.syntax.literal);
...
const $BaseObject = $.makeType(_.spec, "1885eb9d-1509-11ed-92e0-d37f6885e4cb", _.syntax.literal);

const BaseObject= _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null, true);

const $Object_188bed8e150911eda3afcf443ef691de = $.makeType(_.spec, "188bed8e-1509-11ed-a3af-cf443ef691de", _.syntax.literal);

const Object_188bed8e150911eda3afcf443ef691de= _.syntax.$PathNode($.$toSet($Object_188bed8e150911eda3afcf443ef691de, $.Cardinality.Many), null, true);

const $FreeObject = $.makeType(_.spec, "1892f0c0-1509-11ed-a05a-9df174f0ecd5", _.syntax.literal);
...
function min(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "115be10f-1509-11ed-adea-a14e3eacd3f8", optional: false, setoftype: true, variadic: false}], returnTypeId: "115be10f-1509-11ed-adea-a14e3eacd3f8", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "116449e7-1509-11ed-b8a5-e30df5bba93e", optional: false, setoftype: true, variadic: false}], returnTypeId: "116449e7-1509-11ed-b8a5-e30df5bba93e", returnTypemod: "OptionalType", preservesOptionality: true},
...
function contains(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::contains', args, _.spec, [
    ...
    {args: [{typeId: "d7ad54f4-0694-596f-9457-e1946b1cf1b7", optional: false, setoftype: false, variadic: false}, {typeId: "d7ad54f4-0694-596f-9457-e1946b1cf1b7", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
    {args: [{typeId: "d7ad54f4-0694-596f-9457-e1946b1cf1b7", optional: false, setoftype: false, variadic: false}, {typeId: "11555474-1509-11ed-a5bf-0f3a13ff9845", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
...
function range_is_empty(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_is_empty', args, _.spec, [
    {args: [{typeId: "d7ad54f4-0694-596f-9457-e1946b1cf1b7", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function range_get_upper(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_get_upper', args, _.spec, [
    {args: [{typeId: "d7ad54f4-0694-596f-9457-e1946b1cf1b7", optional: false, setoftype: false, variadic: false}], returnTypeId: "11555474-1509-11ed-a5bf-0f3a13ff9845", returnTypemod: "OptionalType"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function sequence_reset(...args) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "1c14ef62-1509-11ed-9810-cdb00e2aad3e", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "1c14ef62-1509-11ed-9810-cdb00e2aad3e", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { $JsonEmptyλEnum, JsonEmpty, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_188bed8e150911eda3afcf443ef691de, Object_188bed8e150911eda3afcf443ef691de, $FreeObject, FreeObject };
...
const __defaultExports = {
  ...
  "Object": Object_188bed8e150911eda3afcf443ef691de,
