...
export declare type $Object_190dbb9a150911edb29f09418a943953λShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
declare type $Object_190dbb9a150911edb29f09418a943953 = $.ObjectType<"schema::Object", $Object_190dbb9a150911edb29f09418a943953λShape, null>;
declare const $Object_190dbb9a150911edb29f09418a943953: $Object_190dbb9a150911edb29f09418a943953

declare const Object_190dbb9a150911edb29f09418a943953: $.$expr_PathNode<$.TypeSet<$Object_190dbb9a150911edb29f09418a943953, $.Cardinality.Many>, null, true> 

export declare type $SubclassableObjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
export declare type $DeltaλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $SourceλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_190dbb9a150911edb29f09418a943953λShape & {
...
export declare type $ModuleλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & $AnnotationSubjectλShape & {
}>;
...
export declare type $ParameterλShape = $.typeutil.flatten<$Object_190dbb9a150911edb29f09418a943953λShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
